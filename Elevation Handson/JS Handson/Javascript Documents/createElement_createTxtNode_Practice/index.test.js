...
test('Checking Created TextNode',()=>{
    ...
    expect(out).toBe(" Inner content containing some random stuff Created Content.");
})
...
test('Checking Created Element',()=>{
    ...
    expect(out).toBe(" Inner content containing some random stuff part 2<span>(New Content)</span>");
})